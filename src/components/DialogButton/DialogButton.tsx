...
export const DialogButton = ({
  ...
  const containerStyle: React.CSSProperties = {
    ...
    paddingTop: (container.paddingTop as number | undefined) ?? 11,
    paddingRight: (container.paddingRight as number | undefined) ?? 32,
    paddingBottom: (container.paddingBottom as number | undefined) ?? 13,
  ...
  const textStyle: React.CSSProperties = {
    ...
    display: text.display as React.CSSProperties["display"],
    justifyContent: text.justifyContent as React.CSSProperties["justifyContent"],
    flexDirection: text.flexDirection as React.CSSProperties["flexDirection"],
    fontSize: (text.fontSize as number | undefined) ?? 11,
    fontFamily: (text.fontFamily as string | undefined) ?? "Arial",
